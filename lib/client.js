...
var _dysmsapi = require('@alicloud/dysmsapi-2017-05-25');

var _dysmsapi2 = _interopRequireDefault(_dysmsapi);

var _dybaseapi = require('@alicloud/dybaseapi');

var _dybaseapi2 = _interopRequireDefault(_dybaseapi);

var _mns = require('@alicloud/mns');
...
var SMSClient = function () {
  function SMSClient(options) {
    ...
    this.dysmsapiClient = new _dysmsapi2.default({ accessKeyId: accessKeyId, secretAccessKey: secretAccessKey, endpoint: DYSMSAPI_ENDPOINT });
    this.dybaseClient = new _dybaseapi2.default({ accessKeyId: accessKeyId, secretAccessKey: secretAccessKey, endpoint: DYBASEAPI_ENDPOINT });
    this.expire = [];
    this.mnsClient = [];
  }
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(this.mnsClient && this.mnsClient[type] instanceof _mns2.default && this._refresh(type))) {
                  _context.next = 2;
                  break;
                }
              ...
              case 11:
                mnsClient = new _mns2.default('1943695596114318', {
